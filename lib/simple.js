	...
	let fsizedoc = '1'.repeat(10)    
     ...
     if (buffer) try { (type = await conn.getFile(buffer), buffer = type.data) } catch { buffer = buffer }
          ...
          forwardedNewsletterMessageInfo: {
            ...
            newsletterName: '𝙎𝙖𝙨𝙪𝙠𝙚﹝⚡️﹞𝐔𝐩𝐝𝐚𝐭𝐞', 
            serverMessageId: '' }, 
                ...options
                }
                })
...
let canalId = ["120363323510940493@newsletter", "120363323510940493@newsletter", "120363323510940493@newsletter", "120363323510940493@newsletter", "120363323510940493@newsletter"]
let canalNombre = ["𝙎𝙖𝙨𝙪𝙠𝙚﹝⚡️﹞𝐔𝐩𝐝𝐚𝐭𝐞", "𝙎𝙖𝙨𝙪𝙠𝙚﹝⚡️﹞𝐔𝐩𝐝𝐚𝐭𝐞", "𝙈𝙤𝙝𝙖𝙢𝙚𝙙 𝘼𝙧𝙚𝙣𝙚", "𝙈𝙤𝙝𝙖𝙢𝙚𝙙 𝘼𝙧𝙚𝙣𝙚", "𝙎𝙖𝙨𝙪𝙠𝙚﹝⚡️﹞𝐔𝐩𝐝𝐚𝐭𝐞"]
